...
/**for(let i=0; i<moles.length;i++){
    dom_moles[i].addEventListener("click", moles[i].defeated());
}*/

/**for(let i=0; i<moles.length;i++){
    moles[i].getDOM().addEventListener("click", moles[i].defeated());
}*/

for(const mole of moles){
    mole.getDOM.addEventListener("click", function(){mole.defeated()});
